...
const buildStyles = () => `
  ...
  * { box-sizing: border-box; }
  ...
  .topnav { display: flex; gap: 14px; flex-wrap: wrap; font-size: 13px; margin-bottom: 18px; }
  .hero {
  ...
  h1 { margin: 0 0 8px; color: var(--text-bright); font-size: 28px; line-height: 1.2; }
  ...
  .toc h2, .key-points h2 { margin: 0 0 10px; font-size: 16px; color: var(--text-bright); }
  ul { margin: 0; padding-left: 20px; }
  .sections { display: grid; gap: 14px; }
  .section { padding: 18px; }
  .section h2 { margin: 0 0 10px; font-size: 18px; color: var(--text-bright); }
  ...
  th { background: rgba(0, 212, 255, 0.08); color: var(--text-bright); font-size: 11px; }
  .pager {
    margin-top: 18px;
    display: grid;
  ...
  .hub-item h2 { margin: 0 0 6px; font-size: 16px; color: var(--text-bright); }
  .hub-item p { margin: 0; color: var(--text-muted); font-size: 13px; }
`;
