import { initUI } from './ui.js?v=20260302d';
import { createQuizController } from './quiz.js?v=20260302d';
import { loadContent } from './content.js?v=20260302d';
import { createAssistant } from './assistant.js?v=20260302d';
